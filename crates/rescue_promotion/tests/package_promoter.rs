...
fn copy_operations(
    ...
    vec![
        CopyOperation {
            ...
            expected_source_sha256: source_hash.to_string(),
        ...
        CopyOperation {
            ...
            expected_source_sha256: audio_hash.to_string(),
    ...
    PackageValidationResult {
        ...
        file_records: vec![
            FileValidationRecord {
                operation_id: "copy_als".to_string(),
                target_relative_path: PathBuf::from("Set.als"),
                expected_sha256: rewritten_hash.to_string(),
            ...
            FileValidationRecord {
                operation_id: "copy_audio".to_string(),
                target_relative_path: PathBuf::from("Samples/Imported/shared.wav"),
                expected_sha256: audio_hash.to_string(),
