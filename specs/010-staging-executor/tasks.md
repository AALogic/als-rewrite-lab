...
- [x] Define StagingExecutionRequest and StagingExecutionResult v0.3.
...
- [x] ENFORCED_BY_TEST: missing_ableton_project_marker_in_plan_is_rejected_before_writes
...
- [x] ENFORCED_BY_TEST: metadata_only_audio_copy_records_no_content_hash
...
- [x] ENFORCED_BY_TYPE: DirectoryExecutionRecord
